...
class DictionaryTest < Test::Unit::TestCase
  ...
  VALID_UNITS = ['cmH2O','nights','% of days','days','liters/minute','','minutes','cm','events per hour','%','years','hours','events','seconds','mmHG','kg','attempts','items'] #Example ['mmHG','bpm','readings','minutes','%','hours','MET']
